...
public class Photo extends Model {
    ...
    public enum Tag {
        ...
        WHOLE_OR_DETAIL("whole_or_detail", 0x80, R.string.photo_tag_whole, R.drawable.ic_landscape_white_48dp, R.string.photo_tag_detail, R.drawable.ic_local_florist_white_48dp),
